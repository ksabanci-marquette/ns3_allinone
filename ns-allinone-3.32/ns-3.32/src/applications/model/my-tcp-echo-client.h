...
#ifndef MY_TCP_ECHO_CLIENT_H
#define MY_TCP_ECHO_CLIENT_H
 ...
 */
    class MyTcpEchoClient : public Application
    {
    public:
        ...
        virtual ~MyTcpEchoClient ();


        void SetTagCounter(uint8_t tagCounter);

        void SetPacketSizes(uint32_t * sizes);

        uint32_t * GetPacketSizes();

        void SetClientNo(uint8_t clientNo);
    ...
    private:
        ...
        uint32_t totalPacketSize = 0; // bytes
        int startingIndex;
        uint8_t m_clientNo;
