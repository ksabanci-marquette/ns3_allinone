 ...
 */
#ifndef MY_TCP_ECHO_HELPER_H
#define MY_TCP_ECHO_HELPER_H
 ...
 */
class MyTcpEchoServerHelper
{
public:
  /**
   * Create MyTcpEchoServerHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param port The port the server will wait on for incoming packets
   */
  //MyTcpEchoServerHelper (Ipv4Address address, uint16_t port);
  MyTcpEchoServerHelper (Address address, uint16_t port);
  MyTcpEchoServerHelper (Address address, uint16_t port,u_int32_t mss);
  MyTcpEchoServerHelper (uint16_t port);
  ...
  void SetPacketSizes (Ptr<Application> app, uint32_t *fill);
 ...
 */
class MyTcpEchoClientHelper
{
public:
  /**
   * Create MyTcpEchoClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param ip The IP address of the remote tcp echo server
   * \param port The port number of the remote tcp echo server
   */
  //MyTcpEchoClientHelper (Ipv4Address ip, uint16_t port);
  MyTcpEchoClientHelper (Address ip, uint16_t port);
