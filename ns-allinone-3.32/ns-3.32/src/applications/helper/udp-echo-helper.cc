...
void UdpEchoServerHelper::SetPacketSizes (Ptr<Application> app, uint32_t *fill)
{
  app->GetObject<UdpEchoServer>()->SetPacketSizes (fill);
}
...
void UdpEchoClientHelper::SetPacketSizes (Ptr<Application> app, uint32_t *fill)
{
  app->GetObject<UdpEchoClient>()->SetPacketSizes (fill);
}
