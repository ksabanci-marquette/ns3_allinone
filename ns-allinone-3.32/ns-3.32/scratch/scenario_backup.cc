...
int main (int argc, char *argv[])
{
 ...
 // Create the Internet
  ...
  p2ph.EnablePcapAll("scenario.pcap");
...
*/
    ...
    //csma.EnableAsciiAll (ascii.CreateFileStream ("scenario_pcap.tr"));
    //csma.EnablePcapAll ("scenario_pcap", true);
